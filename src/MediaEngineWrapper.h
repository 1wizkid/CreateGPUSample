...
#include "SampleGenerator.h"//richfr01
...
namespace media
{
    ...
    public:
        ...
        HRESULT RuntimeClassInitialize(SampleGenerator* p_pSampleGenerator, IMFSourceReader* sourceReader,
    ...
    private:
        HRESULT CreateMediaEngine(SampleGenerator* p_pSampleGenerator, IMFSourceReader* sourceReader);//richfr01
        void OnLoaded();
        ...
        SampleGenerator *m_pSampleGenerator = NULL;//richfr01
