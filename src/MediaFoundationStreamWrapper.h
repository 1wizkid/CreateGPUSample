...
namespace media {
    ...
    public:
        ...
        HRESULT RuntimeClassInitialize(uint32_t sourceStreamId, uint32_t mediaStreamId, GUID streamType, IMFMediaSource* parentSource, SampleGenerator *p_pSampleGenerator, IMFSourceReader* sourceReader);
